  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "flex justify-center pt-1 pb-3 relative items-center w-full border-b border-border mb-2",
        caption_label: "hidden", // Hide the redundant label when using dropdowns
        caption_dropdowns: "flex gap-3 justify-center items-center",
        dropdown_month: "text-sm px-2 py-1",
        dropdown_year: "text-sm px-2 py-1",
        vhidden: "sr-only",
